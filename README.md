...
```bash
curl -L https://github.com/kawakamimoeki/cs/releases/download/v0.1.7/cs-linux-amd64 -o cs
chmod +x cs
...
```bash
curl -L https://github.com/kawakamimoeki/cs/releases/download/v0.1.7/cs-macos-amd64 -o cs
chmod +x cs
sudo mv cs /usr/local/bin/
```
...
```powershell
Invoke-WebRequest https://github.com/kawakamimoeki/cs/releases/download/v0.1.7/cs-windows-amd64.exe -OutFile cs.exe
